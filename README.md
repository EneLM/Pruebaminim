...
The lab introduces the fundamentals of Control Engineering through simulation and rapid controller prototyping with the free Arduino support packages for MATLAB and Simulink: [https://mathworks.com/arduino] (https://mathworks.com/arduino).

A working copy of MATLAB is required. An Arduino board can be acquired at [https://www.arduino.cc] (https://www.arduino.cc)
